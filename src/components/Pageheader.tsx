      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Comprehensive SAP integration and consulting services designed specifically for manufacturing enterprises. 
            From system implementation to business transformation, we deliver solutions that drive operational efficiency, 
