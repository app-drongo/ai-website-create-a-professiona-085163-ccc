      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            For over 15 years, we've been the trusted partner for manufacturing executives seeking seamless SAP integration and digital transformation. 
            Our proven expertise drives operational efficiency and business growth across the manufacturing sector.
          </p>
        </div>
      </div>
    </section>
