          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry leaders who have transformed their manufacturing processes with our proven SAP integration solutions. 
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Industry-tested approach with guaranteed results
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Manufacturing Focus</h3>
              <p className="text-sm text-muted-foreground">
                Specialized expertise in manufacturing operations
              </p>
            </div>
          </div>
        </div>
